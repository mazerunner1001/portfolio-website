...
const ProfileSection = () => {
  ...
  return (
    <>
      {/* Render 3D Lanyard outside container with absolute positioning */}
      {!isSimpleLanyard && (
        <div
          style={{
            position: 'fixed',
            left: lanyardPosition.left,
            top: lanyardPosition.top,
            width: lanyardPosition.width,
            height: '100vh',
            zIndex: 150, // Higher than navigation and other elements
            pointerEvents: 'auto',
            overflow: 'visible'
          }}
        >
      ...
      <div 
        ...
        style={{
          width: '32%',
          flexShrink: 0,
          paddingTop: isSimpleLanyard ? '80px' : '0',
          paddingLeft: '0',
          paddingRight: '0',
          display: 'flex',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            {isSimpleLanyard ? <SimpleLanyard /> : <div style={{ height: '400px' }} />}
          </div>
        </div>
      </div>
    </>
