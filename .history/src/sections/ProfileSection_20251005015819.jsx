  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        width: isSimpleLanyard ? '100%' : '200vw', // Much wider for 3D lanyard
        maxWidth: isSimpleLanyard ? '340px' : 'none', // No max width restriction for 3D
        zIndex: 100,
        ...
        left: isSimpleLanyard ? '0' : '-50vw' // Center the wider container for 3D
      }}>
        <div style={{ 
