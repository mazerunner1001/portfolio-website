  ...
  const education = [
    {
      ...
      grade: "CGPA: 8.06/10",
      highlights: [
        "Secured All India Rank 7375 in JEE Advanced 2022, top 1% among 1,50,000 candidates",
        "Secured All India rank 2962 in JEE MAINS 2022 among 1.7 lac shortlisted candidates",
        "Ranked among the top 50 students in the state-wide level AS EAMCET",
        "Achieved Codeforces max rating: 1663",
        "Achieved Worldwide rank 87 in CodeChef Starters 200 (2025)"
      ]
    },
    {
      id: 2,
    ...
    },
    {
      ...
      grade: "GPA: 10/10",
      highlights: [
        "Perfect score in CBSE board examinations"
      ]
    }
  ];
