...
const MainLayout = () => {
  ...
  return (
    <>
      {/* 3D Lanyard positioned absolutely at the very top level - completely outside all containers */}
      {!isSimpleLanyard && (
        <div style={{
          position: 'fixed',
          top: '0',
          left: '7.5%', // Align with the main container's left edge
          width: '27.2%', // 32% of 85% (the main container width)
          height: '100vh',
