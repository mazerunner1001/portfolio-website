    ...
    <>
      <nav className="navigation">
        <div className="nav-container">
          ...
          {/* CLI/GUI Toggle Switch */}
          <div className="mode-toggle">
            <div className={`toggle-switch ${isCLIMode ? 'cli' : 'gui'}`} onClick={handleCLIToggle}>
              <div className="toggle-background">
                <span className="toggle-option gui">GUI</span>
                <span className="toggle-option cli">CLI</span>
              </div>
