                ...
                >
                  {it.type === 'video' ? (
                    <video 
                      ...
                      preload="metadata"
                      onError={(e) => {
                        console.error('Video error:', it.src, e);
                        // Hide the video element on error
                        e.target.style.display = 'none';
                      }}
                      onLoadStart={() => console.log('Video loading:', it.src)}
                      onCanPlay={() => console.log('Video can play:', it.src)}
                      style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover',
                    ...
                    >
                      {/* Fallback content for unsupported videos */}
                      <div style={{
                        width: '100%',
                        height: '100%',
                        backgroundColor: '#333',
